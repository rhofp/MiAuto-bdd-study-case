...
-- Author :       rho
--
-- Date Created : Sunday, January 17, 2021 22:48:34
...
-- 
-- TABLE: PAIS_F1_RFP_S1 
--

CREATE TABLE PAIS_F1_RFP_S1(
...
-- 
-- TABLE: SUCURSAL_F1_RFP_S1 
--

CREATE TABLE SUCURSAL_F1_RFP_S1(
    ...
    CONSTRAINT SUCURSAL_F1_PAIS_ID_FK FOREIGN KEY (PAIS_ID)
    REFERENCES PAIS_F1_RFP_S1(PAIS_ID)
)
;
...
CREATE TABLE AUTO_F1_RFP_S1(
    ...
    CONSTRAINT AUTO_F1_MODELO_ID_FK FOREIGN KEY (MODELO_ID)
    REFERENCES MODELO_R_RFP_S1(MODELO_ID),
    CONSTRAINT AUTO_F1_STATUS_AUTO_ID_FK FOREIGN KEY (STATUS_AUTO_ID)
    REFERENCES STATUS_AUTO(STATUS_AUTO_ID),
    CONSTRAINT AUTO_F1_SUCURSAL_ID_FK FOREIGN KEY (SUCURSAL_ID)
    REFERENCES SUCURSAL_F1_RFP_S1(SUCURSAL_ID)
)
;
...
CREATE TABLE AUTO_CARGA_F1_RFP_S1(
    ...
    CONSTRAINT RefAUTO_F1_RFP_S1131 FOREIGN KEY (AUTO_ID)
...
CREATE TABLE AUTO_PARTICULAR_F1_RFP_S1(
    ...
    CONSTRAINT RefAUTO_F1_RFP_S1121 FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F1_RFP_S1(AUTO_ID)
)
;
...
CREATE TABLE PAGO_AUTO_F1_RFP_S1(
    ...
    CONSTRAINT PAGO_AUTO_F1_AUTO_ID_FK FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F1_RFP_S1(AUTO_ID)
)
;
