...
--insert into ..
-- Insercion de paises
insert into F_RFP_PAIS_1 (pais_id,clave,nombre,region_economica) 
values(1,'MX','MEXICO','A');

-- Insercion de suscriptores 1
insert into F_RFP_SUSCRIPTOR_1 (suscriptor_id,num_tarjeta)  
...
-- Insercion de pais 2
insert into F_RFP_PAIS_2 (pais_id,clave,nombre,region_economica) 
