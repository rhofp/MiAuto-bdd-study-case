...
insert into status_auto(status_auto_id,clave,descripcion) values(3,'APARTADO','El cliente ha realizado un depóosito');
...
insert into status_auto(status_auto_id,clave,descripcion) values(6,'EN REPARACION','Para autos vendidos en reparación');