...
--@Descripcion:         Creacion de sinonimos en rfpbd_s1

-- Pais (2)
create or replace synonym pais_f1 for pais_f1_rfp_s1;
create or replace synonym pais_f2 for pais_f2_rfp_s2@rfpbd_s2;

-- Sucursal (3)
create or replace synonym sucursal_f1 for sucursal_f1_rfp_s1;
...
-- Auto (3)
create or replace synonym auto_f1 for auto_f1_rfp_s1;
...
-- Auto Particular (2)
create or replace synonym auto_particular_f1 for auto_particular_f1_rfp_s1;
create or replace synonym auto_particular_f2 for auto_particular_f2_rfp_s2@rfpbd_s2;

-- Auto Carga (2)
create or replace synonym auto_carga_f1 for auto_carga_f1_rfp_s1;
...
create or replace synonym hist_status_auto_f2 for hist_status_auto_f2_efm_s2@efmbd_s2;
...
-- Pago Auto (2)
create or replace synonym pago_auto_f1 for pago_auto_f1_rfp_s1;
...
-- Marca (4)
create or replace synonym marca_r1 for marca_r_rfp_s1;
...
-- Modelo (4)
create or replace synonym modelo_r1 for modelo_r_rfp_s1;
