...
-- Author :       rho
--
-- Date Created : Thursday, January 14, 2021 13:57:39
...
CREATE TABLE SUCURSAL_F2_RFP_S2(
    ...
    CONSTRAINT RefPAIS_F2_RFP_S21 FOREIGN KEY (PAIS_ID)
...
CREATE TABLE MODELO_R_RFP_S2(
    ...
    CONSTRAINT RefMARCA_R_RFP_S27 FOREIGN KEY (MARCA_ID)
...
CREATE TABLE AUTO_F2_RFP_S2(
    ...
    CONSTRAINT RefSUCURSAL_F2_RFP_S23 FOREIGN KEY (SUCURSAL_ID)
    ...
    CONSTRAINT RefMODELO_R_RFP_S28 FOREIGN KEY (MODELO_ID)
...
CREATE TABLE AUTO_CARGA_F2_RFP_S2(
    ...
    CONSTRAINT RefAUTO_F2_RFP_S213 FOREIGN KEY (AUTO_ID)
...
CREATE TABLE AUTO_PARTICULAR_F2_RFP_S2(
    ...
    CONSTRAINT RefAUTO_F2_RFP_S212 FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F2_RFP_S2(AUTO_ID)
)
;
...
CREATE TABLE PAGO_AUTO_F2_RFP_S2(
    ...
    CONSTRAINT RefAUTO_F2_RFP_S210 FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F2_RFP_S2(AUTO_ID)
)
;
