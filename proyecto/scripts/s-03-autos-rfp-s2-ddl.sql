...
-- Author :       rho
--
-- Date Created : Sunday, January 17, 2021 22:52:58
-- Target DBMS : Oracle 11g
--

-- 
-- TABLE: MARCA_R_RFP_S2 
--

CREATE TABLE MARCA_R_RFP_S2(
...
-- 
-- TABLE: MODELO_R_RFP_S2 
--

CREATE TABLE MODELO_R_RFP_S2(
    ...
    REFERENCES MARCA_R_RFP_S2(MARCA_ID)
)
;
...
-- 
-- TABLE: PAIS_F2_RFP_S2 
--

CREATE TABLE PAIS_F2_RFP_S2(
...
-- 
-- TABLE: SUCURSAL_F2_RFP_S2 
--

CREATE TABLE SUCURSAL_F2_RFP_S2(
    ...
    CONSTRAINT SUCURSAL_F2_PAIS_ID_FK FOREIGN KEY (PAIS_ID)
    REFERENCES PAIS_F2_RFP_S2(PAIS_ID)
)
;
...
-- 
-- TABLE: AUTO_F2_RFP_S2 
--

CREATE TABLE AUTO_F2_RFP_S2(
    ...
    CONSTRAINT AUTO_F2_MODELO_ID_FK FOREIGN KEY (MODELO_ID)
    REFERENCES MODELO_R_RFP_S2(MODELO_ID),
    CONSTRAINT AUTO_F2_STATUS_AUTO_ID_FK FOREIGN KEY (STATUS_AUTO_ID)
    REFERENCES STATUS_AUTO(STATUS_AUTO_ID),
    CONSTRAINT AUTO_F2_SUCURSAL_ID_FK FOREIGN KEY (SUCURSAL_ID)
    REFERENCES SUCURSAL_F2_RFP_S2(SUCURSAL_ID)
)
;
...
-- 
-- TABLE: AUTO_CARGA_F2_RFP_S2 
--

CREATE TABLE AUTO_CARGA_F2_RFP_S2(
    AUTO_ID             NUMBER(10, 0)    NOT NULL,
    ...
    CONSTRAINT RefAUTO_F2_RFP_S2132 FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F2_RFP_S2(AUTO_ID)
)
;
...
-- 
-- TABLE: AUTO_PARTICULAR_F2_RFP_S2 
--

CREATE TABLE AUTO_PARTICULAR_F2_RFP_S2(
    AUTO_ID          NUMBER(10, 0)    NOT NULL,
    NUM_CILINDROS    NUMBER(1, 0)     NOT NULL,
    NUM_PASAJEROS    NUMBER(1, 0)     NOT NULL,
    CLASE            CHAR(1)          NOT NULL,
    CONSTRAINT AUTO_PARTICULAR_PK PRIMARY KEY (AUTO_ID), 
    CONSTRAINT RefAUTO_F2_RFP_S2122 FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F2_RFP_S2(AUTO_ID)
)
;
...
-- 
-- TABLE: CLIENTE_F1_RFP_S2 
--

CREATE TABLE CLIENTE_F1_RFP_S2(
    CLIENTE_ID            NUMBER(10, 0)    NOT NULL,
    NOMBRE                VARCHAR2(40)     NOT NULL,
    AP_PATERNO            VARCHAR2(40)     NOT NULL,
    AP_MATERNO            VARCHAR2(40)     NOT NULL,
    NUM_IDENTIF1CACION    VARCHAR2(18)     NOT NULL,
...
-- 
-- TABLE: PAGO_AUTO_F2_RFP_S2 
--

CREATE TABLE PAGO_AUTO_F2_RFP_S2(
    CLIENTE_ID     NUMBER(10, 0)    NOT NULL,
    AUTO_ID        NUMBER(10, 0)    NOT NULL,
    ...
    CONSTRAINT PAGO_AUTO_F2_AUTO_ID_FK FOREIGN KEY (AUTO_ID)
    REFERENCES AUTO_F2_RFP_S2(AUTO_ID)
)
;
...
-- 
-- TABLE: TARJETA_CLIENTE_F1_RFP_S2 
--

CREATE TABLE TARJETA_CLIENTE_F1_RFP_S2(
    CLIENTE_ID     NUMBER(10, 0)    NOT NULL,
