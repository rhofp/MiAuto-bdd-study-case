...
\input{bdd_proyecto-frags}

\section*{Creación de fragmentos}
...

{
  ...
  %%%%% Start: Table header 
    \textbf{Núm.} &
  \textbf{Nombre de la tabla padre} & 
  \textbf{Nombre de la tabla hija} & 
  \textbf{Sitio}
  \\ \hline
  %%%%% End: Table header 
  %
  % row 1
  \stepcounter{constraintCounter} \arabic{constraintCounter} &
  ...
  % row 13
  \stepcounter{constraintCounter} \arabic{constraintCounter} &
  \fragNameBuilder{\marca}{R}{\snIII}& 
  \fragNameBuilder{\modelo}{R}{\snIII}& 
  \snIII 
  \\ \hline
  %
  % row 14
  ...
  % row 15
  \stepcounter{constraintCounter} \arabic{constraintCounter} &
  \fragNameBuilder{\marca}{R}{\snIV}& 
  \fragNameBuilder{\modelo}{R}{\snIV}& 
  \snIV
  \\ \hline
  %
  % row 16
